        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AsignadoId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreadorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Deadline = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Prioridad = table.Column<int>(type: "int", nullable: false),
                    Estado = table.Column<int>(type: "int", nullable: false),
                    DificultadEstimada = table.Column<int>(type: "int", nullable: true),
                    TiempoEstimadoHoras = table.Column<double>(type: "float", nullable: true),
                    TiempoRealHoras = table.Column<double>(type: "float", nullable: true),
                    NotasPrivadas = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClasificacionInterna = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Departamentos_Usuarios_LiderId",
                table: "Departamentos",
                column: "LiderId",
                principalTable: "Usuarios",
                principalColumn: "Id",
